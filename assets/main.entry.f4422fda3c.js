...
function I(t, e) {
  -1 === t.$$.dirty[0] &&
    (k.push(t), _ || ((_ = !0), L.then(q)), t.$$.dirty.fill(0)),
...
function wt() {
  const t = i(ut) - 0.06666666666666667;
  t < 0 || ut.set(t);
}
function xt() {
  const t = i(ut) + 0.06666666666666667;
  ...
  return {
    c() {
      (n = m("div")),
        ...
        (o = m("div")),
        (s = m("div")),
        (s.innerHTML = 'REC <span class="svelte-1d3vptt"></span>'),
        (i = h()),
        (l = m("div")),
        (a = v(e[2])),
        y(c, "class", "tv-video"),
        y(c, "channel", "camera"),
        (c.autoplay = !0),
        y(s, "class", "rec svelte-1d3vptt"),
        y(l, "class", "counter"),
        y(o, "class", "rec-wrapper big-text glitchy-text svelte-1d3vptt"),
    ...
    (t.$$.update = () => {
      if (16 & t.$$.dirty) {
        const t = parseInt((a % 1e3) / 100),
          e = jt(Math.floor((a / 1e3) % 60)),
          c = jt(Math.floor((a / 6e4) % 60)),
          r = jt(Math.floor((a / 36e5) % 24));
        n(2, (u = `${r}:${c}:${e}.${t}`));
      }
    }),
    [
  ...
  return {
    c() {
      (n = m("video")),
        ...
        r.src !==
          ...
          y(r, "src", o),
        y(r, "type", "video/webm"),
        s.src !== (i = "/assets/videos/channel-" + e[4].displayName + ".mp4") &&
          y(s, "src", i),
        y(s, "type", "video/mp4"),
        y(n, "class", "tv-video"),
    ...
    p(t, [e]) {
      16 & e &&
        ...
        16 & e &&
          s.src !==
            (i = "/assets/videos/channel-" + t[4].displayName + ".mp4") &&
          y(s, "src", i),
  ...
  return (
    ...
    (t.$$.update = () => {
      ...
      4 & t.$$.dirty &&
        ...
        36 & t.$$.dirty &&
          (i === ct || c === ct ? Rt() : Bt && (Bt.stop(), (Bt = null)));
    }),
    [r, p, c, o, s, i]
  );
}
  ...
  return {
    c() {
      ...
      (z = h()),
        ...
        y(L, "class", "hide-text svelte-1vrpccc"),
        y(O, "class", "svelte-1vrpccc"),
        y(T, "class", "control mute svelte-1vrpccc"),
        y(q, "class", "svelte-1vrpccc"),
        y(j, "class", "control ch up svelte-1vrpccc"),
  ...
  return {
    ...
    m(t, e) {
      d(t, n, e),
        ...
        u(n, p),
        u(n, b),
        w || ((x = [g(r, "click", bt), g(b, "click", yt)]), (w = !0));
    },
    p(t, [e]) {
    ...
    for (var w = b.length - 1; $ < o - 3; )
      for (
        ...
        (l = t((p = b[i]), l, a, v, (m = b[i + 1]))),
          ...
          (l = p);
    for (; $ < o; )
      for (v = n.charCodeAt(s + (l = $)), f = ++$, i = 0; i < w; i += 2)
        (p = b[i]), (b[i] = f = t(p, l, f, v, b[i + 1])), (l = p);
    return f;
  };
})();
...
async function he(t) {
  ...
  const [{ title: e, slots: n }] = await Promise.all([ve(t), et(300)]);
  pt.set(rt),
    Q(() => {
      me({ title: e, slots: n }),
        (document.title = e),
...
function ye() {
  ...
  t.external ? window.open(t.url, "_blank") : he(t.url);
}
function $e() {
  ...
  Q(() => {
    Ae(),
      ...
      Y.addEventListener("mousemove", (t) => {
        fe(t.target) &&
          (oe.has(t.target.href) || ve(t.target.href, { importante: "low" }));
      }),
      Y.addEventListener("click", (t) => {
        ...
        fe(t.target) && (t.preventDefault(), he(t.target.href));
      }),
      new Wt({ target: it }),
